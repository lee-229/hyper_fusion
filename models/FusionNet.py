...
class FusionNet(nn.Module):
    def __init__(self,data_in_channel):
        ...
        self.spectral_num = data_in_channel
        self.conv1 = nn.Conv2d(in_channels=data_in_channel, out_channels=128, kernel_size=3, stride=1, padding=1,
                               bias=True)
        self.res1 = Resblock()
        self.res2 = Resblock()
        self.res3 = Resblock()
        ...
        self.conv3 = nn.Conv2d(in_channels=128, out_channels=data_in_channel, kernel_size=3, stride=1, padding=1,
                               bias=True)
    ...
    def forward(self, y, x):  # x= lupms; y = pan
